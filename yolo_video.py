...
#inputVideoPath="./DRONE.mp4"
#outputVideoPath="./results.avi"
#preDefinedConfidence=0.2
	...
	if len(idxs) > 0:
		...
		for i in idxs.flatten():
			...
			cv2.putText(frame, text, (x, y - 5),
				cv2.FONT_HERSHEY_SIMPLEX, 0.5, [255,0,0,3], 2)
